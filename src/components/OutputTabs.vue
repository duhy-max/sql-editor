<template>
  <div class="output-container">
    ...
    <div class="output-content" v-if="activeResult">
      <!-- 普通查询/DDL 表格内容 -->
      <template v-if="!activeResult.component && !activeResult.loading">
        ...
        <div class="editor-toolbar">
         ...
         <template v-else-if="activeResult.loading">
					  <div class="loading-state">
						...
						正在执行 SQL，请稍候...
						<pre class="loading-message">{{ activeResult.message }}</pre>
					  </div>
					</template>
